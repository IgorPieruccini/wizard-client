...
describe("<PlayerInstruction/>", ()=> {
    ...
    it("Match Prediction + Player turn", ()=> {
        ...
        expect(screen.getByText("Pick the number of times you can win the table.")).toBeInTheDocument();
    ...
    it("Match Prediction + not Player turn", ()=> {
        ...
        expect(screen.getByText("Player Ms.Java is predicting their win.")).toBeInTheDocument();
    ...
    it("Match Play cards + Player turn", ()=> {
        ...
        expect(screen.getByText("Player Ms.Java is piking a card.")).toBeInTheDocument();
